...
df_verify = pd.read_excel("delete.xlsx")
...
def check_relation_with_llama(subject, property, object):
    logprob_true = query_with_logprobs(
        MODEL_Q8_0, f"Is the relation [{subject}, {property}, {object}] accurate? Answer with one word: TRUE or FALSE."
    )
    return logprob_true
